...
* 注意：一定要会看git修改历史记录，按照修改记录看代码可以很好地理解与原项目地差异。
---
...
* 调试的核心作用：快速定位问题以及了解项目的运行逻辑
---

## 验收内容

* 使用虚拟环境完成依赖安装并运行py-xiaozhi项目
* 参考src里的iot里的smarthome.py 添加一个额外的设备，可以收发mqtt数据，并使用mqttx测试通过
